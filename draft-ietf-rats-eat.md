...
The "manifests" claim ({{manifests}}) along with the measurement and "swevidence" ({{swevidence}})) claims are examples of this, allowing the use of CoSWID, TEEP Manifests and other formats.
