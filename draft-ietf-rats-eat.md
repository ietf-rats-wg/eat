...
### The Measurements and Software Evidence Claim (measurements) {#measurements}
...
The manifests claim ({{manifests}}) along with the measurement and software evidence ({{measurements}})) claims are examples of this, allowing the use of CoSWID, TEEP Manifests and other formats.
