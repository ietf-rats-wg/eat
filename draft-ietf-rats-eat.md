...
Each claim is appended to the `$$Claims-Set-Claims` socket. Specifications that define additional claims MUST also supply additions to the `$$Claims-Set-Claims` socket.
